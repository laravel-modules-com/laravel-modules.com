...
{{--                    <a href="/">Docs</a>--}}
            ...
            <div class="flex items-center justify-end gap-6 lg:shrink-0">
                ...
                <div class="flex gap-2 items-center">
                    <a href="https://github.com/nWidart/laravel-modules" class="rounded-md p-1 text-gray-400 transition-colors hover:text-gray-300 focus:outline-none focus-visible:ring focus-visible:ring-pink-400/50">
